...
// ===========================================================================================
class Ghost {
    constructor(initialPosition, maze) {
        this.position = initialPosition;
        this.maze = maze;
    }
    // Roda a BFS
    findPathToPacman(pacmanPosition) {
...
export default class Game {
    constructor(maze, ghostPos, pacmanPos) {
        this.initialPath = [];
        this.maze = maze;
    ...
    printDetailedState(path, initialPath) {
        console.clear();
        console.log("\n=== Estado Atual do Jogo ===");
        // Imprime posições
        console.log(`Fantasma: (${this.ghost.getPosition().x}, ${this.ghost.getPosition().y})`);
        ...
        // Marca o caminho com '*'
        path.forEach((pos) => {
            if (!this.isSamePosition(pos, this.ghost.getPosition()) &&
